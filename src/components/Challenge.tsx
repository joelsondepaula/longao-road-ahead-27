...
const Challenge = () => {
  ...
  return (
    <section id="desafio" className="py-24 bg-gradient-to-br from-asphalt-dark via-slate-900 to-asphalt-dark text-road-white relative overflow-hidden">
      {/* Background Pattern */}
            ...
            {stats.map((stat, index) => (
              <Card 
                ...
                className={`
                  ...
                  ${stat.highlight 
                    ? 'md:col-span-2 lg:col-span-1 bg-gradient-to-br from-success-green/10 to-trust-blue/10 border-2 border-road-yellow/50' 
                    : 'bg-gradient-to-br from-road-white/5 to-road-white/10 border border-road-yellow/30 hover:border-road-yellow/60'
                  }
              ...
              >
                ...
                <CardContent className="relative z-10">
                  {stat.number ? (
                    ...
                    <p className="text-road-yellow font-bold text-lg text-center leading-tight">{stat.value}</p>
                  )}
                </CardContent>
              </Card>
            ))}
            ...
            <Card className="group bg-gradient-to-br from-road-white/5 to-road-white/10 border border-road-yellow/30 hover:border-road-yellow/60 transition-all duration-500 hover:scale-[1.02] backdrop-blur-sm shadow-2xl">
              ...
              <CardContent className="space-y-6">
                {objectives.map((objective, index) => (
                  <div 
                    key={index} 
                    className="group/objective flex items-start space-x-4 p-4 rounded-xl bg-gradient-to-r from-road-yellow/5 to-premium-gold/5 border border-road-yellow/20 hover:border-road-yellow/40 transition-all duration-300 hover:scale-105"
                  >
